    ...
    <q-page padding>
        <q-btn icon="sort" class="float-right" flat ref="target">
            ...
            <q-menu auto-close anchor="bottom right" self="top middle">
                <q-item clickable @click.native="sortOption = 'scrollasc'">Scroll Asc</q-item>
                <q-item clickable @click.native="sortOption = 'scrollsc'">Scroll Desc</q-item>
            </q-menu>
        </q-btn>
            ...
            >
                ...
                <q-item-section>
                    ...
                    <q-item-label
                        ...
                        caption
                    >{{b.original.officer + (b.original.officer === "Recruitment"?" Chairman":"")}}</q-item-label>
                </q-item-section>
            </q-item>
